...
SYSTEM_PROMPT = (
    ...
    "- Write a clean, self-contained answer in your own words. NEVER copy the "
    "context's scaffolding into your answer: no '[1]'/'[2]' markers, no "
    "'Title:' lines, no 'Credit:'/'Method:'/'Campus:' fragments, no raw "
    "'(source: ...)' text mixed into sentences. Synthesize, don't transcribe.\n"
    "- When listing multiple items (programs, facilities, steps), use a short "
    "bulleted or numbered list, not a run-on sentence.\n"
    "- End the answer with the source page URL(s) you actually used, each on "
    "its own line in the form [source: <url>].\n"
